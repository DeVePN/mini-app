      ...
      <div className="bg-white border-b border-gray-200 sticky top-0 z-10">
        <div className="max-w-4xl mx-auto px-4 py-4">
          ...
          <div className="flex items-center gap-3">
            <span className="text-4xl">{getCountryFlag(node.countryCode)}</span>
            <div>
              <h1 className="text-2xl font-bold">{node.country}</h1>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-lg font-semibold">{node.latency || '--'}ms</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-lg font-semibold">{stats?.activePeers || 0}</p>
              </div>
            </div>
            ...
            {node.reputation !== undefined && (
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-lg font-semibold">{node.reputation.toFixed(1)} / 5.0</p>
                </div>
              </div>
            )}
        ...
        <Card>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="text-sm text-gray-600">Price per second</p>
                <p className="text-2xl font-bold text-green-600">
                  {formatTON(node.pricePerSecond)} TON
                </p>
              </div>
            </div>
            <div className="text-right text-sm text-gray-600">
              <p>~{formatTON(String(Number(node.pricePerSecond) * 60))} TON/min</p>
              <p>~{formatTON(String(Number(node.pricePerSecond) * 3600))} TON/hr</p>
            </div>
          </div>
        </Card>
        ...
        <Card>
          ...
          <div className="space-y-3 text-sm">
            ...
            <div className="flex justify-between">
              ...
              <span className="font-mono">{formatAddress(node.publicKey, 8)}</span>
            </div>
            <div className="flex justify-between">
